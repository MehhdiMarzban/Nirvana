            ...
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  ...
                  >
                    <div className="mt-4 mb-2 font-medium text-lg">Nirvana</div>
                    <p className="text-muted-foreground text-sm leading-tight">
                    Nirvana is a modern and responsive e-commerce platform
                      built with Next.js
                    </p>
                  </Link>
                </NavigationMenuLink>
              ...
              <ListItem
                target="_blank"
                title="GitHub"
                href="https://github.com/MehhdiMarzban"
              >
                Source code of the Nirvana project.
              </ListItem>
              <ListItem
                target="_blank"
                href="https://mehdi-marzban.ir"
                title="Author"
              >
                Mehdi Marzban - Author of the Nirvana
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
