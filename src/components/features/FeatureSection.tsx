...
export function FeaturesSection() {
    const features = [
        ...
        {
            title: "Ease of use",
            description: "We've got you covered. You don't need to know how to code to use us.",
            icon: <IconEaseInOut />,
        },
        {
        ...
        },
        {
            ...
            description: "It works on all devices, including mobile phones and tablets.",
...
const Feature = ({
    ...
    return (
        <div
            ...
            <div className="relative z-10 mb-4 px-10 text-foreground group-active/feature:scale-105 transition-all ease">
                {icon}
            </div>
            ...
            <p className="relative z-10 max-w-xs px-10 text-foreground/75 text-sm">{description}</p>
        </div>
    );
};
