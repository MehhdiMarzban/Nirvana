...
export default () => {
    ...
    const { updateQuantity, items: carts, removeItem, total } = useCartStore((state) => state);
        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent>
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Thank you for shopping with us! You can add or remove items in your cart and
                        complete your purchase anytime. If you need assistance, feel free to contact
                        us.
                    </SheetDescription>
                </SheetHeader>
