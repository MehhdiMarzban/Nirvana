...
const Products = ({ products, onClose }: { products: any[]; onClose: () => void }) => {
    return (
        <ScrollArea className={products ? "h-60" : "h-0"}>
            {products?.map((product: any) => (
                <Link
                    ...
                    />
                    <div>
                        <p className="line-clamp-1 font-medium text-sm/6">{product.title}</p>
                    ...
                    {isPending ? (
                        ...
                        <div className="mt-4 flex flex-col items-center gap-4 text-center text-muted-foreground">
                            ...
                            <p className="text-sm">
                                ...
                                <span className="font-semibold">{query}</span>". Try again with a
                                different keyword.
                            </p>
